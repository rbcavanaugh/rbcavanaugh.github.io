...
# Knit the HTML version
  rmarkdown::render("cv-2page/cv-cavanaugh-2page.Rmd")
  
  file.copy(here("cv-2page", "cv-cavanaugh-2page.html"),
              here("cv-cavanaugh.html"), overwrite = T)
 

# Convert to PDF using Pagedown
pagedown::chrome_print(input = here("cv-cavanaugh.html"),
                       output = here::here("cv-2page", "cv-cavanaugh.pdf"))

file.copy(here("cv-2page", "cv-cavanaugh.pdf"),
