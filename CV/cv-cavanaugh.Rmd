...
--------------------------------------------------------------------------------
<div id="position">
<span style="font-size:1.1rem">Assistant Professor</span><br>
...
<!-- `r fontawesome::fa("envelope")` rcavanaugh1@mgb.org `r knitr::asis_output("\U00B7")` -->
...
Certificates and Licensure {data-icon=certificate}
--------------------------------------------------------------------------------
<hr>
...
```{r class.source="pubs"}
#CV %<>% print_section('mentored_grants', glue_template = "grant")
```

<!-- ## Pending -->

```{r class.source="pubs"}
# CV %<>% print_section('pending_grants', glue_template = "grant")
```

## Not Funded

```{r class.source="pubs"}
CV %<>% print_section('not_funded_grants', glue_template = "grant")
```
...
Presentations & Invited Talks {data-icon=chalkboard-teacher}
--------------------------------------------------------------------------------
<hr>
*Mentored Student / Trainee works are underlined*
