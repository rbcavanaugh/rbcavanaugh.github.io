...
[`r fontawesome::fa("twitter")` Twitter](https://twitter.com/Littlejohnsband){class=borders} 
[`r fontawesome::fa("github")` Github](https://github.com/rbcavanaugh){class=borders} 
[`r fontawesome::fa("paper-plane")` Email](rob.cavanaugh@pitt.edu){class=borders}
[`r fontawesome::fa("university")` Pitt Lab](https://lrcl.pitt.edu){class=borders}
